...
public class Materia_Controller {
    ...
    public void botoesAtivos() {
        ...
        for (Materia_Model model : dao.selectAll()) {
           ...
           Image imagem = pegarImagem(model.getIdMatricula());
            switch (i) {
               
                case 1:
                    if ( imagem != null) {
                        view.getBtn1().setIcon(new ImageIcon(imagem));
                    }
                    else {
                        view.getBtn1().setIcon(null);
                    }
                ...
                case 2:
                    ...
                    if (imagem != null) {
                        ...
                        view.getBtn2().setIcon(new ImageIcon(imagem));
                    }
                    else {
                        view.getBtn2().setIcon(null);
                    }
                ...
                case 3:
                    if (imagem != null) {
                        ...
                        view.getBtn3().setIcon(new ImageIcon(imagem));
                    }
                    else {
                        view.getBtn3().setIcon(null);
                    }
                ...
                case 4:
                    if (imagem != null) {
                        ...
                        view.getBtn4().setIcon(new ImageIcon(imagem));
                    }
                    else {
                        view.getBtn4().setIcon(null);
                    }
                ...
                case 5:
                    if (imagem != null) {
                        ...
                        view.getBtn5().setIcon(new ImageIcon(imagem));
                    }
                    else {
                        view.getBtn5().setIcon(null);
                    }
                ...
                case 6:
                    if (imagem != null) {
                        ...
                        view.getBtn6().setIcon(new ImageIcon(imagem));
                    }
                    else {
                        view.getBtn6().setIcon(null);
                    }
                ...
                case 7:
                    if (imagem != null) {
                        ...
                        view.getBtn7().setIcon(new ImageIcon(imagem));
                    }
                    else {
                        view.getBtn7().setIcon(null);
                    }
                ...
                case 8:
                    if (imagem != null) {
                        ...
                        view.getBtn8().setIcon(new ImageIcon(imagem));
                    }
                    else {
                        view.getBtn8().setIcon(null);
                    }
                ...
                case 9:
                    if (imagem != null) {
                        ...
                        view.getBtn9().setIcon(new ImageIcon(imagem));
                    }
                    else {
                        view.getBtn9().setIcon(null);
                    }
                ...
                case 10:
                    if (imagem != null) {
                        ...
                        view.getBtn10().setIcon(new ImageIcon(imagem));
                    }
                     else {
                        view.getBtn10().setIcon(null);
                    }
                ...
                case 11:
                    if (imagem != null) {
                        ...
                        view.getBtn11().setIcon(new ImageIcon(imagem));
                    }
                     else {
                        view.getBtn11().setIcon(null);
                    }
                ...
                case 12:
                    if (imagem != null) {
                        ...
                        view.getBtn12().setIcon(new ImageIcon(imagem));
                    }
                     else {
                        view.getBtn12().setIcon(null);
                    }
                ...
                case 13:
                    if (imagem != null) {
                        ...
                        view.getBtn13().setIcon(new ImageIcon(imagem));
                    }
                     else {
                        view.getBtn13().setIcon(null);
                    }
                ...
                case 14:
                    if (imagem != null) {
                        ...
                        view.getBtn14().setIcon(new ImageIcon(imagem));
                    }
                    else {
                        view.getBtn14().setIcon(null);
                    }
                ...
                case 15:
                    if (imagem != null) {
                        ...
                        view.getBtn15().setIcon(new ImageIcon(imagem));
                    }
                    else {
                        view.getBtn15().setIcon(null);
                    }
                ...
                case 16:
                    if (imagem != null) {
                        view.getBtn16().setIcon(new ImageIcon(imagem));
                    }
    ...
    public void iniciar() {
        ...
        view.getBtn2().setVisible(false);
        view.getText2().setVisible(false);
        view.getBtn3().setVisible(false);
        view.getText3().setVisible(false);
        view.getBtn4().setVisible(false);
        view.getText4().setVisible(false);
        view.getBtn5().setVisible(false);
        view.getText5().setVisible(false);
        view.getBtn6().setVisible(false);
        view.getText6().setVisible(false);
        view.getBtn7().setVisible(false);
        view.getText7().setVisible(false);
        view.getBtn8().setVisible(false);
        view.getText8().setVisible(false);
        view.getBtn9().setVisible(false);
        view.getText9().setVisible(false);
        view.getBtn10().setVisible(false);
        view.getText10().setVisible(false);
        view.getBtn11().setVisible(false);
        view.getText11().setVisible(false);
        view.getBtn12().setVisible(false);
        view.getText12().setVisible(false);
        view.getBtn13().setVisible(false);
        view.getText13().setVisible(false);
        view.getBtn14().setVisible(false);
        view.getText14().setVisible(false);
        view.getBtn15().setVisible(false);
        view.getText15().setVisible(false);
        view.getBtn16().setVisible(false);
        view.getText16().setVisible(false);
        botoesAtivos();
    }
